...
fn sf_1() {
	...
	test_eval("99 to 1 sf", "approx. 100");
}
...
fn test_scientific_notation_edge_cases() {
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("2 + pi i to 4 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 2.000 × 10^0 + (3.142 × 10^0)i"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("666 to 2 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 6.7 × 10^2"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("199 to 2 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 2.0 × 10^2"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("999 to 1 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 1 × 10^3"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("999.9 to 1 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 1 × 10^3"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("999 to 2 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 1.0 × 10^3"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("999.9 to 2 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 1.0 × 10^3"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("0.9999 to 2 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"approx. 1.0 × 10^0"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("0.5i to 4 sn", &mut context)
			.unwrap()
			.get_main_result(),
		"(5.000 × 10^-1)i"
	);
	...
	let mut context = Context::new();
	assert_eq!(
		evaluate("0b1011 to 2 sn", &mut context)
			.unwrap()
			.get_main_result(),
