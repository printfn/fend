...
The current latest version of fend is `1.0.1`. You can check your version at any time by typing `version`. If you are using the command-line interface, you can also run `fend -v`.
